    ...
    <>
      ...
      <div className="container mx-auto px-4 text-center md:text-left">
        <div className="flex flex-wrap items-center mt-32">
          ...
          <video src="/PrviRazred.mp4"  className="max-w-full rounded-lg shadow-lg" playsinline autoPlay loop muted/>
          </div>
        </div>
      </div>
    </section>
        ...
        <section className="relative py-20">
          ...
          <div  data-aos="fade-in" className="container mx-auto px-4 text-center md:text-left" style={{marginBottom: "10%"}}>
            <div className="items-center flex flex-wrap">
              <div className="w-full md:w-4/12 ml-auto mr-auto px-4">
              <video src="/DrugiRazred.mp4"  className="max-w-full rounded-lg shadow-lg" playsinline autoPlay loop muted/>
        ...
        <section data-aos="fade-in" className="pb-20 bg-blueGray-200 -mt-24" style={{paddingTop: "15%"}}>
          <div className="container mx-auto px-4 text-center md:text-left">
            <div className="flex flex-wrap items-center mt-32">
              ...
              <div className="w-full md:w-4/12 ml-auto mr-auto px-4">
              <video src="/TreciRazred.mp4"  className="max-w-full rounded-lg shadow-lg" playsinline autoPlay loop muted/>
        ...
        <section className="relative py-20">
          ...
          <div  data-aos="fade-in" className="container mx-auto px-4">
            <div className="items-center flex flex-wrap">
              <div className="w-full md:w-4/12 ml-auto mr-auto px-4">
              <video src="/CetvrtiRazred.mp4"  className="max-w-full rounded-lg shadow-lg" playsinline autoPlay loop muted/>
